...
function withUnimodules(webpackConfig = {}, env = {}, argv = {}) {
    ...
    if (!webpackConfig.module)
        ...
        webpackConfig.module = Object.assign(Object.assign({}, webpackConfig.module), { rules: [] });
    ...
    const locations = env.locations || env_1.getPaths(environment.projectRoot, environment);
    ...
    webpackConfig.output = Object.assign(Object.assign({}, webpackConfig.output), { publicPath });
